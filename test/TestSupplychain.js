...
contract('SupplyChain', function(accounts) {
    ...
    // 1st Test
    it("Testing smart contract function harvestItem() that allows a farmer to harvest lettuce", async() => {
    ...
    // 2nd Test
    it("Testing smart contract function processItem() that allows a farmer to process lettuce", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 3rd Test
    it("Testing smart contract function packItem() that allows a farmer to pack lettuce", async () => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 4th Test
    it("Testing smart contract function sellItem() that allows a farmer to sell lettuce", async () => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 5th Test
    it("Testing smart contract function buyItem() that allows a distributor to buy lettuce", async () => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 6th Test
    it("Testing smart contract function shipItem() that allows a distributor to ship lettuce", async () => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 7th Test
    it("Testing smart contract function receiveItem() that allows a retailer to mark lettuce received", async () => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 8th Test
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase lettuce", async () => {
        const supplyChain = await SupplyChain.deployed()
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just nassert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)
